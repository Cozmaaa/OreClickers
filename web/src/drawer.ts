import { Game, GAME_STATES, GameState } from "./app.js"
...
export class Drawer {
    ...
    handleDrawState(gameState: GameState, lobbyName?: string, currentName?: string) {
    ...
    private drawCreateLobby(currentName: string | undefined) {
        this.game.ctx.fillStyle = 'black';
        this.game.ctx.fillRect(0, 0, this.game.ctx.canvas.width, this.game.ctx.canvas.height);
        this.game.ctx.fillStyle = 'white';
        this.game.ctx.font = "50px serif"
    ...
    private drawInsertUsername(currentName: string | undefined) {
    ...
    private drawJoinLobby(currentName: string | undefined) {
